/*
 * AngklungineX Arc-2 — Free Play Mode
 *
 * 14 note buttons arranged in piano style
 * Tap → Serial.send("NOTE_ON"), Release → Serial.send("NOTE_OFF")
 */
...
const FreeMode = {
  ...
  init() {
    ...
    // Group by octave for row layout
    const rows = [
